...
class Card {
  setCard() {
    const card = [
      new CardText(
        "مركز صيانة جنرال اليكتريك مصر مباشرة",
        ...
        "مركز صيانة جنرال اليكتريك في مصر يقدم خدمات صيانة احترافية بأعلى معايير الجودة والكفاءة، لضمان أداء ممتاز لجميع أجهزتكم"
      ),
      ...
      new CardText(
        ...
        "نوفر خدمات شاملة لصيانة ودعم أجهزة جنرال اليكتريك في جميع المحافظات، لضمان راحة عملائنا في أي وقت وأي مكان"
      ),
      ...
      new CardText(
        ...
        "نحرص على تقديم قطع غيار أصلية لجميع أجهزة جنرال اليكتريك لضمان أداء موثوق ومستمر لعملائنا"
      ),

      new CardText(
        "خدمة عملاء جنرال اليكتريك مصر",
