  ...
  setCard() {
    const card = [
      new CardText(
        ...
        "مركز صيانة شارب في مصر يقدم خدمات صيانة احترافية بأعلى معايير الجودة والكفاءة، لضمان أداء ممتاز لجميع أجهزتكم"
      ),
      ...
      new CardText(
        ...
        "نوفر خدمات شاملة لصيانة ودعم أجهزة شارب في جميع المحافظات، لضمان راحة عملائنا في أي وقت وأي مكان"
      ),
      ...
      new CardText(
        ...
        "نحرص على تقديم قطع غيار أصلية لجميع أجهزة شارب لضمان أداء موثوق ومستمر لعملائنا"
      ),
