  ...
  setCard() {
    const card = [
      new CardText(
        ...
        "مركز صيانة سامسونج في مصر يقدم خدمات صيانة احترافية بأعلى معايير الجودة والكفاءة، لضمان أداء ممتاز لجميع أجهزتكم"
      ),
      ...
      new CardText(
        ...
        "نوفر خدمات شاملة لصيانة ودعم أجهزة سامسونج في جميع المحافظات، لضمان راحة عملائنا في أي وقت وأي مكان"
      ),
      ...
      new CardText(
        ...
        "نحرص على تقديم قطع غيار أصلية لجميع أجهزة سامسونج لضمان أداء موثوق ومستمر لعملائنا"
      ),

      new CardText(
        "خدمة عملاء سامسونج مصر",
