  ...
  setCard() {
    const card = [
      new CardText(
        ...
        "مركز صيانة فريش في مصر يقدم خدمات صيانة احترافية بأعلى معايير الجودة والكفاءة، لضمان أداء ممتاز لجميع أجهزتكم"
      ),
      ...
      new CardText(
        ...
        "نوفر خدمات شاملة لصيانة ودعم أجهزة فريش في جميع المحافظات، لضمان راحة عملائنا في أي وقت وأي مكان"
      ),
      ...
      new CardText(
        ...
        "نحرص على تقديم قطع غيار أصلية لجميع أجهزة فريش لضمان أداء موثوق ومستمر لعملائنا"
      ),
